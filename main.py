...
# st.markdown(
#     """
#     Welcome to the *Fashion Sense Recommender System!* Please provide your details below to get personalized outfit recommendations. Fashion is not just about clothes; it's a way to express yourself. Let's find the perfect style for you!
#     """
# )

# # User history display logic
...
#     # Sidebar checkbox for input method selection
...
#         # Button to get recommendations based on custom text input
#         if st.button("Get Recommendation"):
#             if custom_query:
#                 print(custom_query)
#                 try:
#                     # Get recommendations from the LLM using custom query
#                     response = chain.invoke({"query": custom_query})
#                     # Access the result and source documents from the response
...
#             else:
#                 st.warning(
#                     " Please enter a question or query to get a recommendation."
#                 )

#     # Selectbox Inputs
#     else:
#         # Create two columns for gender and body shape selectboxes
#         col1, col2 = st.columns(2)

#         # User input fields in the first row
#         with col1:
#             gender = st.selectbox("Select Gender:", ["Male (above 25 years)",
#                                                     "Female (above 25 years)",
#                                                     "Boy (10 - 25 years)",
#                                                     "Girl (10 - 25 years)",
#                                                     "Baby Boy (1 - 10 years)",
#                                                     "Baby Girl (1 - 10 years)"], key="gender")

#         with col2:
#             body_shape = st.selectbox("Select Body Shape:", ["Hourglass", "Pear", "Apple", "Rectangle", "Inverted Triangle", "Athletic", "Round"], key="body_shape")

#         # Create two columns for age and height selectboxes
#         col3, col4 = st.columns(2)

#         # User input fields in the second row
#         with col3:
...
#         # Create two columns for weight and occasion selectboxes
#         col5, col6 = st.columns(2)

#         # User input fields in the third row
#         with col5:
...
#         # Create two columns for fashion style and skin tone selectboxes
#         col7, col8 = st.columns(2)

#         # User input fields in the fourth row
#         with col7:
...
#         # Button to get recommendations based on selectbox inputs
#         if st.button("Recommend Fashion"):
#             # Formulate the query based on user inputs
#             query = f"""
#             Gender: {gender}
#             Age: {age}
...
#             Please recommend an outfit based on the above details.
#             """

#             try:
#                 # Get recommendations from the LLM using the selectbox inputs
